...
class TestAPICourierCreate:
    ...
    def test_create_new_courier_successful(self, create_and_delete_courier):
        courier_signin = requests.post(TestAPIBaseLinks.MAIN_URL + TestAPICourierLinks.COURIER_URL, data=create_and_delete_courier)
    ...
    def test_create_double_courier_is_failed(self, create_and_delete_courier):
        requests.post(TestAPIBaseLinks.MAIN_URL + TestAPICourierLinks.COURIER_URL, data=create_and_delete_courier)
        courier_signin_2 = requests.post(TestAPIBaseLinks.MAIN_URL + TestAPICourierLinks.COURIER_URL, data=create_and_delete_courier)
